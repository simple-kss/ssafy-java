...
public class BookTest {
	...
	public static void main(String[] args) {
		...
		bm.add( new Book("00001","Java 다","김상사","jjja.kr",19500,"자바기본문법"));
		bm.add( new Book("00002","Java 라","김중사","jjjb.kr",24000,"c++문법"));
		bm.add( new Book("00003","분석설계","이근희","kkkc.kr",56004,"SW모델"));
		bm.add( new Book("00004","계설석분","전우형","kkkd.kr",24352,"HW모델"));
		bm.add( new Book("00005","설계분석","김성식","kkke.kr",35212,"12모델"));

		bm.add( new Magazine("12344","Java메거진!","홍진호","java.com",5000,"첫걸음",2018,2));
		bm.add( new Magazine("25233","c메거진!","홍정호","jaaa.com",6600,"2걸음",2017,2));
		bm.add( new Magazine("12423","c++메거진!","홍기호","jada.com",2200,"3걸음",2014,2));
		bm.add( new Magazine("11888","J메거진!","홍백호","ja2a.com",1100,"4걸음",2012,2));
		bm.add( new Magazine("12357","Jaa메거진!","홍시호","j3va.com",1500,"5걸음",2011,2));
